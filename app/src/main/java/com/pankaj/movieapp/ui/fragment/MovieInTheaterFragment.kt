...
class MovieInTheaterFragment : Fragment() {

    companion object {
        fun newInstance() = MovieInTheaterFragment()
    ...
    private fun fetchMovies() {
        viewModel.getMovies().observe(this, Observer { response ->
            when (response) {
                ...
                is Outcome.Success -> {
                    val comingSoonData = response.data.movieInTheatre
